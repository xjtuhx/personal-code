...
Private Sub Form_Load()
    txtDB(0) = GetProfileString(App.Path & "\Control.ini", "服务器信息", "服务器A")
    txtUserName(0) = xorPWD(GetProfileString(App.Path & "\Control.ini", "服务器信息", "用户名A"))
    txtPasswd(0) = xorPWD(GetProfileString(App.Path & "\Control.ini", "服务器信息", "口令A"))
    txtDB(1) = GetProfileString(App.Path & "\Control.ini", "服务器信息", "服务器B")
    txtUserName(1) = xorPWD(GetProfileString(App.Path & "\Control.ini", "服务器信息", "用户名B"))
    txtPasswd(1) = xorPWD(GetProfileString(App.Path & "\Control.ini", "服务器信息", "口令B"))
...
Private Sub OKButton_Click()
    ...
    '保存输入正确的信息
    WriteProFileString App.Path & "\Control.ini", "服务器信息", "服务器A", Trim(txtDB(0))
    WriteProFileString App.Path & "\Control.ini", "服务器信息", "用户名A", xorPWD(Trim(txtUserName(0)))
    WriteProFileString App.Path & "\Control.ini", "服务器信息", "口令A", xorPWD(Trim(txtPasswd(0)))
    WriteProFileString App.Path & "\Control.ini", "服务器信息", "服务器B", Trim(txtDB(1))
    WriteProFileString App.Path & "\Control.ini", "服务器信息", "用户名B", xorPWD(Trim(txtUserName(1)))
    WriteProFileString App.Path & "\Control.ini", "服务器信息", "口令B", xorPWD(Trim(txtPasswd(1)))
    IfConnDB = True
